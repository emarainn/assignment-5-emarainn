...
public class FirstNameUtility {
    ...
    //Constructor that initializes the three maps
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException{
        ...
        int firstNameCode = 0; //return type is int
        if(firstNameCodeMap.containsKey(firstName)){//Name
            firstNameCode = firstNameCodeMap.get(firstName.toUpperCase());//Converting it to caps
        }else {//Initial
            firstNameCode = firstInitialCodeMap.get(Character.toString(firstName.charAt(0)).toUpperCase()); //takes first character of the string & Caps
        }
        ...
        }else{//returns the sum of the codes for the first initial and middle initial.
            return firstNameCode + middleInitialCodeMap.get(Character.toString(middleInitial.charAt(0)));//First initial of middle name
        }
    }
}
